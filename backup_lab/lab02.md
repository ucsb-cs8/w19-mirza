...
assigned: 2019-1-23 09:00:00.00-7
due: 2019-1-29 23:59:00.00-7
csxx: cs8
---
...
Similar to lab01, you can check whether pytest is installed by typing in the following command in the Python shell prompt. If it returns no error message, then `pytest` is installed. If you get an error, refer back to [lab01](/w19-mirza/lab/lab01/) for instructions on installing it.
...
(If you need a refresher on how to interpret the output of `pytest`, refer back to [lab01](/w19-mirza/lab/lab01/) 
